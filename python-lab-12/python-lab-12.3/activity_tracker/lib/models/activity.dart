...
class LatLng {
  ...
  factory LatLng.fromJson(Map<String, dynamic> json) => LatLng(json['lat'], json['lng']);
}
...
class ActivityRecord {
  ...
  factory ActivityRecord.fromMap(Map<String, dynamic> map) {
    return ActivityRecord(
      ...
      route: map['route'] != null ? (jsonDecode(map['route']) as List).map((e) => LatLng.fromJson(e)).toList() : null,
    );
  }
}
