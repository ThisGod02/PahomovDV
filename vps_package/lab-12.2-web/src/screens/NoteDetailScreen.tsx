...
const NoteDetailScreen: React.FC<NoteDetailScreenProps> = ({ navigation, route }) => {
    ...
    return (
        <ScrollView style={styles.container}>
            ...
            <NoteMap latitude={note.latitude} longitude={note.longitude} title={note.title} />
...
const styles = StyleSheet.create({
    ...
    contentContainer: { backgroundColor: 'white', padding: 20, marginTop: 1 },
    content: { fontSize: 16, color: '#333', lineHeight: 24 },
    addressContainer: { backgroundColor: 'white', padding: 20, marginTop: 1 },
    addressLabel: { fontSize: 14, fontWeight: 'bold', color: '#333', marginBottom: 4 },
    addressText: { fontSize: 14, color: '#007AFF' },
    mapContainer: { height: 200, marginTop: 1, backgroundColor: 'white' },
    map: { flex: 1 },
    photoContainer: { backgroundColor: 'white', padding: 20, marginTop: 1 },
    photoLabel: { fontSize: 14, fontWeight: 'bold', color: '#333', marginBottom: 8 },
    photo: { width: '100%', height: 200, borderRadius: 8 },
    deleteButton: { backgroundColor: '#ff3b30', margin: 20, padding: 16, borderRadius: 8, alignItems: 'center' },
